...
public class SessionLifecycleManager {
    ...
    public void createNewSession() {
        ...
        String previousReasoningEffort = (oldSession != null)
                ? oldSession.getReasoningEffort()
                : ReasoningEffortStateService.load();
        LOG.info("Preserving session state: mode=" + previousPermissionMode
                         + ", provider=" + previousProvider + ", model=" + previousModel
                         + ", reasoning=" + previousReasoningEffort);
        ...
        interruptFuture.thenRun(() -> {
            ...
            newSession.setReasoningEffort(ReasoningEffortStateService.normalize(previousReasoningEffort));
    ...
    public void loadHistorySession(String sessionId, String projectPath) {
        ...
        if (oldSession != null) {
            ...
            previousReasoningEffort = oldSession.getReasoningEffort();
        } else {
            ...
            previousReasoningEffort = ReasoningEffortStateService.load();
        }
