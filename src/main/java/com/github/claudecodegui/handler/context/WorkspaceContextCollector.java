...
public class WorkspaceContextCollector {
     ...
     */
    public @NotNull JsonObject collectWorkspaceContext(@Nullable Project project) {
     ...
     */
    private boolean checkIsWorkspace(@NotNull Project project) {
     ...
     */
    private @NotNull JsonArray collectSubprojects(@NotNull Project project) {
     ...
     */
    private @Nullable String getHandlerType(@NotNull Object subproject) {
     ...
     */
    private boolean checkSubprojectLoaded(@NotNull Object subproject) {
        if (getHandlerMethod == null) {
            return true;
        }
     ...
     */
    private void collectModuleInfo(@NotNull Project project, @NotNull JsonObject workspaceData) {
        try {
     ...
     */
    private @Nullable String getModuleTypeName(@NotNull Module module) {
        try {
            Object moduleType = module.getOptionValue("moduleType");
            if (moduleType != null) {
                return moduleType.toString();
            }
        } catch (Exception e) {
            LOG.debug("Failed to get module type: " + e.getMessage());
        }
        return null;
    }
     ...
     */
    public @Nullable String getSubprojectForFile(@Nullable Project project, @Nullable String filePath) {
     ...
     */
    private @Nullable String getSubprojectPathFromProvider(@NotNull Project project, @NotNull String filePath) {
        try {
     ...
     */
    private @Nullable String extractSubprojectNameFromPath(@NotNull String path) {
     ...
     */
    private @Nullable String getModuleForFile(@NotNull Project project, @NotNull String filePath) {
        try {
            VirtualFile file = LocalFileSystem.getInstance().findFileByPath(filePath);
            if (file != null) {
