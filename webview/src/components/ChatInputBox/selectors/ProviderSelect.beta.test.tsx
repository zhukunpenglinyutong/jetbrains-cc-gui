...
describe('ProviderSelect Beta badge and first-click notice', () => {
  ...
  it('renders Beta badges on Grok, Kimi, MiniMax, ZCode, OpenCode, PI, OMP and DSH', () => {
    ...
    for (const id of ['grok', 'kimi', 'minimax', 'zcode', 'opencode', 'pi', 'omp', 'dsh']) {
