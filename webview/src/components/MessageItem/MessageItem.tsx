...
/** Hourglass icon used in assistant duration chip (matched to selected style). */
const DurationHourglassIcon = () => (
  <svg
    width="12"
    height="12"
      ...
      {message.type === 'assistant' && !isMessageStreaming && typeof message.durationMs === 'number' && (
        <div className="message-duration">
          <span className="message-duration-inner">
            <span className="message-duration-flag">
              <DurationHourglassIcon />
            </span>
